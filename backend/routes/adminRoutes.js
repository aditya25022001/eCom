...
import { getUsers, deleteUser, getUserById, updateUserAccess, getProductListByAdmin, getProductById, updateProductDetails, deleteProduct, addProduct, getOrdersByAdmin, getOrderDetailsByAdmin, getOrderDetailsForUpdate} from '../controllers/adminController.js'
...
router.route('/order/:id').get(protect,admin,getOrderDetailsByAdmin)
